...
export class MsalService {
    ...
    public login(): void {
        ...
        console.log("asdasdasd",JSON.parse(localStorage.getItem('sessionConfiguration')));
        if(session != null){
            this.tenantConfig = session.b2CData;
        }
        console.log( this.tenantConfig.tenant,this.tenantConfig.clientID, this.tenantConfig.signUpSignInPolicy );
